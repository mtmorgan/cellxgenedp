...
- (v.1.9.1) Add progress bar when updated
...
- (v 1.7.3) Use all collections, datasets, files to determine available
  columns
...
- (v 1.5.2) use CELLxGENE ‘Discover’ API, changing column names of some
  return values. See ‘API changes’ of the ‘Discover and download
  datasets…’ vignette.

BUG FIXES

- (v 1.6.2) Use all collections, datasets, and files when identifying
  available columns.
...
- (v. 1.1.6) use {rjsoncons} CRAN package for queries, rather than local
  implementation. Thanks [@LiNk-NY](https://github.com/LiNk-NY),
  <https://github.com/mtmorgan/cellxgenedp/pull/12>

## cellxgenedp 0.0.7

- (v. 0.0.7) make errors during local cache update more accessible; see
  <https://github.com/mtmorgan/cellxgenedp/issues/1>
